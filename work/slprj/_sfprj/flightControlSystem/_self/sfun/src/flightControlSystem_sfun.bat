...
set PATH=C:\ProgramData\MATLAB\SupportPackages\R2024a\3P.instrset\mingw_w64.instrset\bin;D:\Matlab\extern\include\win64;D:\Matlab\extern\include;D:\Matlab\simulink\include;D:\Matlab\lib\win64;%MATLAB_BIN%;%PATH%
